...
//		_ARIS_LOG_(@"    Atom: %ld",requirement_atom_id);
		...
		RequirementAtom a = this.requirementAtomForId(requirement_atom_id);
		if(a.bool_operator) Log.i(Config.LOGTAG, getClass().getSimpleName() + "      Req: " + a.requirement + " " + a.content_id);//_ARIS_LOG_(@"      Req: %@ %ld",a.requirement,a.content_id);
		else Log.i(Config.LOGTAG, getClass().getSimpleName() + "      Req: Not " + a.requirement + " " + a.content_id);//_ARIS_LOG_(@"      Req: Not %@ %ld",a.requirement,a.content_id);
	}
