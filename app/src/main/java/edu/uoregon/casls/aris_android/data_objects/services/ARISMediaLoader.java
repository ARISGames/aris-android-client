...
//	Map<> //NSMutableDictionary dataConnections;
...
//		else if(mr.media.localURL != null)   { mr.media.data = NSData dataWithContentsOfURL:mr.media.localURL; this.loadMediaFromMR:mr; }
...
//		{
//			MediaResult existingMR = metaConnectionsi;
...
//		{
//			ARISDelegateHandle dh = mr.delegateHandlesi;
